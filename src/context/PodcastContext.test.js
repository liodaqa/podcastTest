...
const TestComponent = () => {
  ...
  return _jsxs('div', {
    children: [
      globalLoading && _jsx('p', { children: 'Loading...' }),
      error && _jsxs('p', { children: ['Error: ', error] }),
      _jsx('ul', {
        'data-testid': 'podcast-list',
        children:
          podcasts?.map((podcast) =>
            _jsx('li', { children: podcast.name }, podcast.id)
          ) || _jsx('p', { children: 'No podcasts available' }),
      }),
      podcastDetail &&
        _jsx('p', {
          'data-testid': 'podcast-detail',
          children: podcastDetail.collectionName,
        }),
      _jsx('button', {
        'data-testid': 'fetch-detail',
        onClick: () => fetchPodcastDetail('1535809341'),
        children: 'Fetch Podcast Detail',
      }),
    ],
  });
};
