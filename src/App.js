    ...
    children: _jsxs(Router, {
      children: [
        ...
        _jsxs('main', {
          ...
          children: [
            _jsx('h1', { children: 'new Test' }),
            _jsx(Suspense, {
              fallback: _jsx(Spinner, {}),
              children: _jsxs(Routes, {
                children: [
                  _jsx(Route, { path: '/', element: _jsx(MainView, {}) }),
                  _jsx(Route, {
                    path: '/podcast/:podcastId',
                    element: _jsx(PodcastDetail, {}),
                  }),
                  _jsx(Route, {
                    path: '/podcast/:podcastId/episode/:episodeId',
                    element: _jsx(EpisodeDetail, {}),
                  }),
                ],
              }),
            }),
