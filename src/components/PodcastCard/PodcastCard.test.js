...
describe('PodcastCard Component', () => {
    ...
    it('renders all required elements', () => {
        render(_jsx(PodcastCard, { image: mockPodcast.artwork, title: mockPodcast.name, author: mockPodcast.artist, description: mockPodcast.summary, descriptionLabel: 'Summary:' }));
    ...
    it('renders without author and description', () => {
        render(_jsx(PodcastCard, { image: mockPodcast.artwork, title: mockPodcast.name }));
        // Verify the image
    ...
    it('uses default description label when not provided', () => {
        render(_jsx(PodcastCard, { image: mockPodcast.artwork, title: mockPodcast.name, author: mockPodcast.artist, description: mockPodcast.summary }));
        // Verify the default description label
        expect(screen.getByText('Description:')).toBeInTheDocument();
        expect(screen.getByText(mockPodcast.summary)).toBeInTheDocument();
    });
    it('renders custom description label when provided', () => {
        render(_jsx(PodcastCard, { image: mockPodcast.artwork, title: mockPodcast.name, author: mockPodcast.artist, description: mockPodcast.summary, descriptionLabel: 'Podcast Summary:' }));
