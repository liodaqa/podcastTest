...
describe('EpisodeTable Component', () => {
    ...
    it('renders the table headers', () => {
        render(_jsx(BrowserRouter, { children: _jsx(EpisodeTable, { episodes: [], podcastId: mockPodcastId }) }));
    ...
    it('renders the correct number of rows for episodes', () => {
        render(_jsx(BrowserRouter, { children: _jsx(EpisodeTable, { episodes: mockEpisodes, podcastId: mockPodcastId }) }));
    ...
    it('renders episode details correctly', () => {
        ...
        mockEpisodes.forEach((episode) => {
            ...
            expect(episodeLink).toHaveAttribute('href', `/podcast/${mockPodcastId}/episode/${episode.trackId}`);
